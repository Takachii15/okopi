    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('AK', 'Alat Kopi'), ('BK', 'Biji Kopi'), ('KL', 'Kopi Liter'), ('TH', 'Teh')], max_length=5, verbose_name='kategori')),
                ('image_main', models.ImageField(upload_to='photos/products/%Y%m/%d/')),
                ('image_1', models.ImageField(upload_to='photos/products/%Y%m/%d/')),
                ('image_2', models.ImageField(blank=True, upload_to='photos/products/%Y%m/%d/')),
                ('image_3', models.ImageField(blank=True, upload_to='photos/products/%Y%m/%d/')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
